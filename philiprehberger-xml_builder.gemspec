...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/philiprehberger/rb-xml-builder'
  spec.metadata['changelog_uri'] = 'https://github.com/philiprehberger/rb-xml-builder/blob/main/CHANGELOG.md'
  spec.metadata['bug_tracker_uri'] = 'https://github.com/philiprehberger/rb-xml-builder/issues'
